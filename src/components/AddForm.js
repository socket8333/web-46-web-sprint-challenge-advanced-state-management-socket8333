...
import { addSmurf, errorNum } from '../actions';
...
const AddForm = (props) => {
    ...
    const handleSubmit = e => {
        ...
        if (state.name === "" || state.position === "" || state.nickname === "") {
            errorMessage = props.errorNum("Name, position and nickname fields are required.");
        } else {
            props.addSmurf({
                name: state.name,
...
export default connect(mapStateToProps, {errorNum, addSmurf})(AddForm);
